...
namespace FronkonGames.Weird.Kaleidoscope
{
  ...
  /// <summary> AnimationCurve parameter with no interpolation. </summary>
  [Serializable]
  public sealed class AnimationCurveParameterNoInterpolation : VolumeParameter<AnimationCurve>
  {
    public AnimationCurveParameterNoInterpolation(AnimationCurve value, bool overrideState = false) : base(value, overrideState) { }

    public override void Interp(AnimationCurve from, AnimationCurve to, float t) => m_Value = to;
  }
}
