...
namespace FronkonGames.Weird.Pinch
{
  ...
  public sealed partial class Pinch
  {
    ...
    private static readonly Pinch[] NoEffects = new Pinch[0];
    ...
    public static Pinch Instance
    {
      get
      {
        ...
        if (pipelineAsset != null)
        {
          ...
          {
            if (scriptableRendererData.rendererFeatures[i] is Pinch)
              return scriptableRendererData.rendererFeatures[i] as Pinch;
          }
        }
